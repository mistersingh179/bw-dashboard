...
const getAdvertisementText: GetAdvertisementText = async (
  ...
  const messages: AnyObject[] = [
    {
      role: "system",
      content: `You are an expert commerce editor.`
    },
    {
      role: "user",
    ...
    },
    {
      ...
      ~~~\n\      
      Article content that goes before your new paragraph:\n${beforeText}\n\
      ~~~\n\
      {for context, your new paragraph will go here}\n\
      ~~~\n\
      Article content that goes after your new paragraph:\n${afterText}\n\
      ~~~\n\
    ...
    {
      role: "assistant",
      content: `Ok, and what rules should I follow?`
    },
    {
      role: "user",
      content: `Follow these important rules:\n\
      • Use a bridge sentence that introduces new information related to the content before your new paragraph without repeating phrases therefrom. \n\
      • Utilize a transition sentence to smoothly connect your paragraph to the content after your new paragraph, maintaining coherence without duplicating phrases therefrom. \n\
      • Use language that is distinct and different from the content before and after your new paragraph to maintain a unique perspective.\n\
      • Provide speculative statements when referencing people, places, or things from the content before and after your new paragraph, using hedge words (like possibly, perhaps, probably, could, would, etc.) to avoid factual assertions.\n\
      ...
      • Your output must be the new paragraph only. Do not include headings or explanations for your answer.\n\
    ...
    async function processCSV() {
      ...
      for await (const element of csvData) {
        ...
        const outputElement: OutputData = {
          ...
          filename: "getAdvertisementText_6-28-2023_0842.ts",
          model: "gpt-3.5-turbo-0301",
          temp: "0",
          ad: ans[0],
          before_ad_after: `${webpage.advertisementSpots[0].beforeText}\n>>>>> \n${ans[0]}\n>>>>>\n${webpage.advertisementSpots[0].afterText}`, 
          pass:  "",
          notes: "added '{for context, your new paragraph will go here}'",
        };
