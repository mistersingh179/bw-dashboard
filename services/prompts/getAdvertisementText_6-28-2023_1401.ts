...
if (require.main === module) {
  (async () => {
    ...
    async function processCSV() {
      ...
      const stream = createReadStream('webpage_campaign_combos_25.csv')
      ...
      for await (const element of csvData) {
        ...
        const outputElement: OutputData = {
          ...
          filename: "getAdvertisementText_6-28-2023_1318.ts",
          model: "gpt-3.5-turbo-0301",
          temp: "top_p: 0.75, temp: 1",
          ad: ans[0],
          before_ad_after: `${webpage.advertisementSpots[0].beforeText}\n>>>>> \n${ans[0]}\n>>>>>\n${webpage.advertisementSpots[0].afterText}`, 
          pass:  "",
          notes: "output 5 ad variations",
        };
