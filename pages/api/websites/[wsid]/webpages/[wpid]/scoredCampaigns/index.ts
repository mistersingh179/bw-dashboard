...
export type ScoredCampaignWithCampaign = ScoredCampaign & {
  campaign: Campaign;
};
...
const handleListScoredCampaigns = async (
  req: NextApiRequest,
  res: NextApiResponse
) => {
  ...
  const scoredCampaigns: ScoredCampaignWithCampaign[] =
    await prisma.scoredCampaign.findMany({
      where: {
        webpage: {
          id: wpid,
          website: {
...
export default withMiddleware(
  "getOnly",
  "auth"
)(scoredCampaignsOfWebpageHandler);
